...
const BLOG = {
  ...
  NOTION_PAGE_ID:
	  process.env.NOTION_PAGE_ID || '88cf79ad14e643bd884e51f6925146f4', //ae18547aa41e4069aa58aa391527c6b4
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Reasoning.Top',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || true, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '回到未來', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '思想，是迷航中的燈塔', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.reasoning.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '英语,学习,同文,博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'Ningsblog@outlook.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  POSTS_SHARE_SERVICES: process.env.NEXT_PUBLIC_POST_SHARE_SERVICES || 'link,wechat,linkedin', // 分享的服務，按顺序显示,逗号隔开
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-3J3M8M1K2Y', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
  ...
  DESCRIPTION:
      process.env.NEXT_PUBLIC_DESCRIPTION || 'Reasoning.Top', // 站点描述，被notion中的页面描述覆盖
